	...
	if(
		...
		if($_POST['modif'] == "true"){
			if($import)
				...
				$requete .= "UPDATE slider_bungalow SET titre='".addslashes($_POST['titre'])."'".$reqFile." WHERE id='".$_POST['slide']."'";
		}else{
			if($import)
				$reqFile = $_FILES["image"]["name"];
			$requete = "INSERT INTO slider_bungalow(id,titre,img) 
					VALUES('".$_POST['slide']."',
...
<head>
	<meta charset="utf-8">
	<title>Administration du slider de la page bungalow</title>
...
<body class="admin">
	<div id="pageContainer">
		<h1>Administration du slider de la page bungalow</h1>
